...
public class VisitRescheduleController {
  ...
  @ResponseBody
  public Records<VisitRescheduleDto> getVisitBookingDetails(GridSettings settings)
      throws IOException {
    return visitRescheduleService
        .getVisitsRecords(DtoLookupHelper.changeLookupForVisitReschedule(settings));
  }
  ...
  public List<LookupDto> getLookupsForVisitReschedule() {
    ...
    List<String> lookupList = TujiokoweConstants.AVAILABLE_LOOKUPS_FOR_VISIT_RESCHEDULE;
