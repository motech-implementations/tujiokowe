...
import org.motechproject.tujiokowe.mapper.ZetesMapper;
  ...
  private List<ZetesSubjectDto> fetchSubjectsFromZetes(LocalDate lastUpdateDate) {
    ...
    try {
      ...
      if (lastUpdateDate != null) {
        query.append(
            "HAVING GREATEST(to_date(subject.\"REFRESH_DATE\", 'dd-MON-yy'), COALESCE(to_date(prime.\"REFRESH_DATE\", 'dd-MON-yy'), '1900-01-01'), "
      ...
      throw new TujiokoweReportException("Error occurred while fetching data from Zetes", e);
    } finally {
