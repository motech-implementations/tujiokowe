...
import org.motechproject.tujiokowe.dto.ExportStatus;
import org.motechproject.tujiokowe.dto.ExportStatusResponse;
import org.motechproject.tujiokowe.service.ExportService;
import org.motechproject.tujiokowe.task.ExportTask;
import org.motechproject.tujiokowe.util.CustomByteArrayOutputStream;
...
public class ExportServiceImpl implements ExportService {
  ...
  private UUID exportEntity(String outputFormat, String fileName, Class<?> entityDtoType, Class<?> entityType, String entityName,  //NO CHECKSTYLE ParameterNumber
    ...
    UUID taskId = exportTask.setExportParams(outputStream, entityDtoType,
        entityType, entityName, exportFields, tableWriter, lookup, lookupFields, queryParams);
