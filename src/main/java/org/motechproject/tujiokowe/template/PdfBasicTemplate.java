package org.motechproject.tujiokowe.template;
...
public abstract class PdfBasicTemplate {
  ...
  public PdfBasicTemplate(String templatePath, Rectangle firstPageRectangle,
    ...
    try {
      ...
      throw new TujiokoweExportException(e.getMessage(), e);
    }
  }
  ...
  protected void setAdditionalCellValue(String cellName, String cellValue) {
    try {
      BaseFont helveticaBold = BaseFont
          .createFont(BaseFont.HELVETICA_BOLD, BaseFont.WINANSI, BaseFont.NOT_EMBEDDED);
      ...
      throw new TujiokoweExportException("No such additional cell: " + cellName, e);
    }
  }
