(function () {
    ...
    var directives = angular.module('tujiokowe.directives', []);
...
*/
    ...
    */
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                scope.$watch("$parent." + attrs.ngModel, function () {
                    $(".tujiokowe-grid").jqGrid('setGridParam', {
                        datatype: 'json',
                        page: 1,
                        postData: {
    ...
    directives.directive('tujiokoweDatePicker', ['$timeout', function($timeout) {
    ...
    directives.directive('visitRescheduleGrid', function ($compile, $timeout) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                elem.jqGrid({
                    url: "../tujiokowe/visitReschedule",
                    datatype: "json",
                    mtype: "GET",
                    colNames: [
                        scope.msg("tujiokowe.visitReschedule.participantId"),
                    ...
                    onCellSelect: function(rowId, iCol, cellContent, e) {
                        if (iCol !== 5) {
                            ...
                            if (extraRowData.earliestDate === undefined || extraRowData.earliestDate === null || extraRowData.earliestDate === "") {
                                ...
                                scope.form = null;
                                var message = "tujiokowe.visitReschedule.participantVisitScheduleOffsetMissing";

                                if (extraRowData.notVaccinated) {
                                    message = "tujiokowe.visitReschedule.participantNotPrimeVaccinated";
                                }

                                scope.showRescheduleModal(scope.msg('tujiokowe.visitReschedule.cannotReschedule'), scope.msg(message));
                            } else {
                                scope.newForm();
                                ...
                                scope.showRescheduleModal(scope.msg('tujiokowe.visitReschedule.update'), scope.msg('tujiokowe.visitReschedule.plannedDateUpdateSuccessful'));
                            }
                        } else {
                            scope.visitForPrint = elem.getRowData(rowId);
                        }
    ...
    directives.directive('tujiokoweReportGrid', function($http) {
        return {
            restrict: 'A',
            link: function(scope, element, attrs) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        elem.jqGrid({
                            ...
                            pager: '#' + attrs.tujiokoweReportGrid,
                            rowNum: 50,
                            rowList: [10, 20, 50, 100],
                            viewrecords: true,
                            loadonce: false,
    ...
    directives.directive('tujiokoweInstancesGrid', function ($rootScope, $route, $timeout) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        elem.jqGrid({
                            url: "../tujiokowe/instances/" + scope.selectedEntity.name,
                            headers: {
                                'Accept': 'application/x-www-form-urlencoded',
                                'Content-Type': 'application/x-www-form-urlencoded'
                            },
                            ...
                            headertitles: true,
                            colModel: colModel,
                            pager: '#' + attrs.tujiokoweInstancesGrid,
                            viewrecords: true,
                            autowidth: true,
                            shrinkToFit: false,
                            gridComplete: function () {
  ...
  directives.directive('tujiokoweEnrollmentGrid', function($http, $compile) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var elem = angular.element(element), filters;
        ...
        elem.jqGrid({
            ...
            formatter: function(cellValue, options, rowObject) {
              if (rowObject.status === 'Enrolled') {
                return "<button id='unenroll" + options.rowId + "' ng-click='unenroll(\"" + rowObject.subject.subjectId + "\")'" +
                  ...
                  scope.msg('tujiokowe.enrollment.btn.unenroll') + "</button>";
                ...
                return "<button id='enroll" + options.rowId + "' ng-click='enroll(\"" + rowObject.subject.subjectId + "\")'" +
                  ...
                  scope.msg('tujiokowe.enrollment.btn.enroll') + "</button>";
              }
              return '';
            }
          }],
          ...
          pager: '#' + attrs.tujiokoweEnrollmentGrid,
          rowNum: 50,
          rowList: [10, 20, 50, 100],
          viewrecords: true,
          loadonce: false,
  ...
  directives.directive('tujiokoweEnrollmentAdvancedGrid', function($http, $compile) {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var elem = angular.element(element), filters;
        ...
        elem.jqGrid({
          url: '../tujiokowe/getEnrollmentAdvanced/' + scope.selectedSubjectId,
          headers: {
            'Accept': 'application/x-www-form-urlencoded',
            'Content-Type': 'application/x-www-form-urlencoded'
          },
          ...
          colNames: ['rowId', scope.msg('tujiokowe.enrollment.subjectId'), scope.msg('tujiokowe.enrollment.campaignName'),
            scope.msg('tujiokowe.enrollment.date'), scope.msg('tujiokowe.enrollment.status'), scope.msg('tujiokowe.enrollment.action')],
          colModel: [{
            name: 'rowId',
            index: 'rowId',
            hidden: true,
